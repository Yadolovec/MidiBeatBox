...
public class BeatBox implements Serializable{
	...
	String[] instrumentsNames = {"Bass Drum","Closed Hi-Hat","Open Hi-Hat","Acoustic Snare","Crash Cymbal",
								 ...
								 "Vibraslap","Low-midi Tom","High Agogo","Open Hi Conga"};
	...
	public static MidiEvent makeEvent (int type, int chan, int note, int power, int tick){
		MidiEvent event = null;
		try{
			ShortMessage a = new ShortMessage();
			a.setMessage(type, chan, note, power);
